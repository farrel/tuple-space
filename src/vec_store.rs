...
///
/// When the margin of [Some] elements drop to less than [VecStore::compact_margin] share of the total number of elements in the [Vec], the [Vec] is compacted using [Vec::retain] and all the
/// [None] elements are removed. The default value of [VecStore::compact_margin] is
